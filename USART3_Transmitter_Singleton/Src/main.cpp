...
public:
    ...
    USART3_Singleton(const USART3_Singleton&) = delete;
    USART3_Singleton& operator=(const USART3_Singleton&) = delete;
    USART3_Singleton(USART3_Singleton&&)noexcept = delete;
       USART3_Singleton& operator=(USART3_Singleton&&)noexcept = delete;
