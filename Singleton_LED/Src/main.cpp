...
int main(){
	GPIO::clock_enable();
	LED<12>& GREEN=LED<12>::create();
	LED<12>& GREEN1=LED<12>::create();
	LED<13>& Orange=LED<13>::create();
	while(true){
		GREEN.on();
		GREEN1.off();
		delay();
